...
#line 390 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
...
#line 384 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
...
#line 362 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    place = std::to_string(value);
    return true;
}
...
#line 413 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
...
#line 403 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    std::ostringstream ss;  
    ss << "push %d\n"
       << "call scanf\n"
...
#line 396 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
...
#line 341 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    return true;
}
...
#line 806 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    if(!expr->gen_Code(identHandler))
        return false;
...
#line 785 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    if (!expr->gen_Code(identHandler))
        return false;
    place = identHandler.newTemp();
...
#line 534 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    if (!expr1->gen_Code(identHandler))
        return false;
    if (!expr2->gen_Code(identHandler))
...
#line 571 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    if (!expr1->gen_Code(identHandler))
        return false;
    if (!expr2->gen_Code(identHandler)) 
...
#line 493 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    if (!expr1->gen_Code(identHandler)) {
        return false;
    }
...
#line 513 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    if (!expr1->gen_Code(identHandler)) {
        return false;
    }
...
#line 611 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    if (!expr1->gen_Code(identHandler))
        return false;
    if (!expr2->gen_Code(identHandler)) 
...
#line 640 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
     if (!expr1->gen_Code(identHandler))
        return false;
    if (!expr2->gen_Code(identHandler)) 
...
#line 669 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    if (!expr1->gen_Code(identHandler))
        return false;
    if (!expr2->gen_Code(identHandler)) 
...
bool GrEExpr::gen_Code(IdentsHandler & identHandler)
#line 698 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
     if (!expr1->gen_Code(identHandler))
        return false;
    if (!expr2->gen_Code(identHandler)) 
...
#line 727 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    if (!expr1->gen_Code(identHandler))
        return false;
    if (!expr2->gen_Code(identHandler)) 
...
#line 756 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
   if (!expr1->gen_Code(identHandler))
        return false;
    if (!expr2->gen_Code(identHandler)) 
...
#line 455 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    if (!expr1->gen_Code(identHandler)) 
        return false;
    if (!expr2->gen_Code(identHandler)) 
...
#line 473 "/home/boris/Desktop/Proyecto/src/genCode.tc"
{
    if (!expr1->gen_Code(identHandler)) {
        return false;
    }
